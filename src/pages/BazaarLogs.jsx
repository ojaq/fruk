                      ...
                      <Card className="mb-2">
                        <CardBody>
                          <div style={{ fontSize: 13 }}>
                            ...
                            <pre style={{ background: '#f8f9fa', padding: 8, borderRadius: 4, maxHeight: 200, overflow: 'auto' }}>{log.data_before ? JSON.stringify(JSON.parse(log.data_before), null, 2) : '-'}</pre>
                            <strong>Data Sesudah:</strong>
                            <pre style={{ background: '#f8f9fa', padding: 8, borderRadius: 4, maxHeight: 200, overflow: 'auto' }}>{log.data_after ? JSON.stringify(JSON.parse(log.data_after), null, 2) : '-'}</pre>
                          </div>
                        </CardBody>
                      </Card>
                    </Collapse>
